...
describe('Basic user flow for Website', () => {
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for(let i = 1; i < products.length; i++){
      ...
      const buttonInner = await button.getProperty('innerText');
      if (buttonInner['_remoteObject'].value != 'Remove from Cart') {removeText = false};
    }
  ...
  it('Checking the localStorage to make sure cart is correct', async () => {
    ...
    const cartArray = await page.evaluate((x)=>{
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for(let i = 1; i < products.length; i++){
      ...
      const buttonInner = await button.getProperty('innerText');
      if (buttonInner['_remoteObject'].value != 'Add to Cart') {removeText = false};
    }
